...
Analyzed geo-location data to visualize and optimize a global route around the world, then collaborated with software engineers to deploy the solution on a publicly-accessible webpage.
